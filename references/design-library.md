...
Created: May 27 2026. Moved from `~/.hermes/references/creative/` to `~/.hermes/references/design/glitch-aesthetic/` on June 1 2026.
...
Reference files for design live under `~/.hermes/references/design/`. This is the current convention. If you find design references at old paths like `~/.hermes/references/creative/`, migrate them here.
