...
`ocas-actualization` was written to `/root/soul/skills/ocas-actualization/` on June 14. It was never installed in the active profile. For 4 days, any attempt to invoke it returned "skill not found." It was only discovered when <operator> asked about it and I searched the SOUL repo directory directly.
