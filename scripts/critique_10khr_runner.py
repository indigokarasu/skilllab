...
# Resolve against HERMES_ROOT or <hermes-root> to avoid broken ~ expansion
# when HOME is set to a profile chroot (e.g., <hermes-home>/home)
_HERMES_ROOT = os.environ.get("HERMES_ROOT", "<hermes-root>")
...
def find_all_skills(skills_dir: str = None, all_profiles: bool = False) -> list:
    ...
    if all_profiles:
        ...
        # chroot (HOME=<hermes-root>/profiles/<profile>/home) expanduser resolves to
